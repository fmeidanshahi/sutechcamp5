                    ...
                    <div class="profile-wrapper" style="background-image: url({{route('home')}}/img/1349232.jpg);">
                        ...
                        <div class="profile-bar">
                            <nav class="navbar navbar-expand-lg navbar-dark">
                                <div class="container">
                                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" id="profile-menu"
                                       data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" 
                                       aria-label="Toggle navigation">
                                       <span class="navbar-toggler-icon"></span>
                                    </button>
                                    <div class=" collapse navbar-collapse" id="navbarSupportedContent">
                                        <ul class="list-group list-group-horizontal  navbar-nav me-auto mb-2 mb-lg-0">
                                            <li class="list-group-item nav-item"><i class="far fa-clock"></i> تاریخ عضویت<div class="profile-value">11مرداد،1400</div></li>
                                            <li class="list-group-item nav-item"><i class="far fa-clone"></i> تعداد مطالب<div class="profile-value">543</div></li>
                                            <li class="list-group-item nav-item"><i class="far fa-star"></i> امتیاز <div class="profile-value">4.2</div></li>
                                            <li class="list-group-item nav-item"><i class="far fa-clock"></i> آخرین بازدید <div class="profile-value">1 هفته پیش</div></li>
                                            <li class="list-group-item nav-item"><i class="far fa-comments"></i> بازخورد <div class="profile-value">120</div></li>
                                          </ul>
                            ...
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                <ul class="list-group activity">
                                    <li class="list-group-item">
                                        <div class="activity-item">
                                            <div class="right-section">
                                                <img src="img/profile2.jpg" class="profile-photo">
                                    ...
                                    <li class="list-group-item">
                                        <div class="activity-item">
                                            <div class="right-section">
                                                <img src="img/profile3.jpg" class="profile-photo">
                                    ...
                                    <li class="list-group-item">
                                        <div class="activity-item">
                                            <div class="right-section">
                                                <img src="img/profile4.jpg" class="profile-photo">
